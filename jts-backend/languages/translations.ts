...
export const translations: Record<Lang, Translation> = {
    fr: {
        ...
        contactsubjectbody: "Votre message a été reçu avec succès.",
    ...
    de: {
        ...
        callationDetail: "Ihre Anfrage für die unten aufgeführte Leistung wurde <strong>storniert</strong>.",
        callationerror: "Wenn dies ein Fehler ist, kontaktieren Sie uns bitte.",
        confirmed_body: "Ihre Anfrage für die folgende Leistung wurde bestätigt.",
