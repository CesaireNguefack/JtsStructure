...
const siteContent = {
  ...
  de: {
    ...
    services: {
      ...
      intro: "Jede Leistung wird an Projektphase, verfügbare Unterlagen und technische Anforderungen angepasst.",
      items: [
        { title: "Tragwerksplanung", text: "Stahlbeton, Stahlbau und tragende Systeme für Neubauten und Bestandsgebäude.", tags: ["Stahlbeton", "Stahl", "Holz"] },
        { title: "Entwurf und Berechnung", text: "Vorbemessung, Lastannahmen, statische Berechnungen und Nachweise.", tags: ["Eurocodes", "Fundamente", "Anschlüsse"] },
        { title: "Technische Expertise", text: "Unabhängige Stellungnahmen, Machbarkeitsanalysen, Prüfung von Unterlagen und Empfehlungen.", tags: ["Gutachten", "Machbarkeit", "Beratung"] },
        { title: "Diagnose und Sanierung", text: "Analyse von Schäden, Rissen, Verformungen sowie Reparatur- und Verstärkungskonzepte.", tags: ["Diagnose", "Verstärkung", "Sanierung"] },
        { title: "Bauherrenberatung", text: "Entscheidungsunterstützung, technische Prüfung, Bedarfsklärung und Projektbegleitung.", tags: ["Beratung", "Koordination", "Entscheidung"] },
        { title: "Kontrolle und Baustellenbegleitung", text: "Tragwerkskontrolle, Vor-Ort-Diagnose, technische Begleitung und Unterstützung in der Ausführung.", tags: ["Baustelle", "Kontrolle", "Begleitung"] },
      ],
    },
    sectors: {
      eyebrow: "Sektoren",
      ...
      items: [
        ["Wohngebäude", "Villen, Mehrfamilienhäuser, Büros, Hotels, Einkaufszentren, Krankenhäuser und Schulen."],
        ["Gewerbebauten", "Tragwerke, Umbauten, Erweiterungen und Tragfähigkeitsprüfungen."],
        ["Industriebau", "Industriestrukturen, technische Träger, Plattformen und Nutzungsanforderungen."],
        ["Ingenieurbauwerke", "Brücken, Stege, Durchlässe, Stahlbetonrahmen und Sonderbauwerke."],
        ["Infrastruktur", "Stützwände, Fundamente, Baugruben und Unterfangungen."],
        ["Technische Studien", "Berechnungen, Diagnosen, strukturelle Verstärkungen und laufende Projekte."],
      ],
    },
    about: {
      title: "JTS Structure",
      ...
      blocks: [
        ["Vision", "Ein anerkannter technischer Partner für Hochbau, Ingenieurbau und Sanierung werden."],
        ["Qualitätsanspruch", "Dokumentierte Methoden, nachvollziehbare Berechnungen und entscheidungsorientierte Kommunikation."],
    ...
    evaluation: {
      ...
      intro: "Beschreiben Sie Ihr Anliegen, um eine erste projektbezogene Rückmeldung zu erhalten.",
    ...
    realisations: {
      title: "Referenzen",
      intro: "Einblick in Projekte, Baustellen, Diagnosen und technische Einsätze.",
    },
    whyChoose: {
      title: "Warum wir?",
      items: [
